...
public class ArticleController {
    ...
    @ResponseBody
    public AjaxResult addArticle(@RequestParam(value = "articleTitle",required = false) String articleTitle,
                                 @RequestParam(value = "articleDescription",required = false) String articleDescription,
                                 ...
                                 @RequestParam(value = "articleSource",required = false) String articleSource,
                                 @RequestParam(value = "articleReleaseDate",required = false) String articleReleaseDate,
                                 @RequestParam(value = "articlePublisher",required = false) String articlePublisher,
                                 @RequestParam(value = "articleAbstract",required = false) String articleAbstract,
                                 ...
                                 @RequestParam(value = "articleReserve1",required = false) String articleReserve1,
                                 @RequestParam(value = "articleReserve2",required = false) String articleReserve2,
                                 @RequestParam(value = "articleReserve3",required = false) String articleReserve3,
        ...
        if(i>0){
            ...
            if(j1>0){
                ...
                boolean savefile1=saveFile(articleCoverPhoto,"D:/upload","pic2",name1x);
                ...
                boolean savefile2=saveFile(articleEnclosure,"D:/upload","file",name2x);

                if(savefile1==true&&savefile2==true){
                    saveFileResult=true;
                }else {
    ...
    public AjaxResult deleteArticleById(@RequestParam(value = "articleId",required = false) Integer[] articleId){
        ...
        for (int k=0;k<articleId.length;k++){
            ...
            i=articleService.deleteArticleById(articleId[k]);
        }
        if(i>0){
            return AjaxResult.success();
        }else{
    ...
    public AjaxResult updateArticle(@RequestParam(value = "articleId",required = false) Integer articleId,
        ...
        if(!articleCoverPhoto.isEmpty()){
            ...
            File file=new File(article.getArticleCoverPhoto());
            if(file.exists()&&file.isFile()) {
                file.delete();
            }
        }
        ...
        if(!articleEnclosure.isEmpty()){
            ...
            Article article = articleService.selectArticleByArticleId(articleId);
            File file=new File(article.getArticleEnclosure());
            if(file.exists()&&file.isFile()) {
                file.delete();
            }
        }
        ...
        uploadFileService.updateUploadFileByArticleId(articleId,"pic2","D:/upload/pic2/"+name1x+articleCoverPhoto.getOriginalFilename());
        //保存封面
        System.out.println("保存封面");
        ...
        //修改文件表
        System.out.println("修改文件表");
        uploadFileService.updateUploadFileByArticleId(articleId,"pic2","D:/upload/pic2/"+name2x+articleEnclosure.getOriginalFilename());
        //保存附件
        System.out.println("保存附件");
